...
class ClassRosterDaoStubImpl implements ClassRosterDao {
    ...
    public ClassRosterDaoStubImpl() {
        // uncomment the next statement to prove that we are 
        // using the Stub implementation via Annotation DI
        // System.out.println("INFO: Using ClassRosterDaoStubImpl");
        
        // Create the only student that the stub will use for testing
